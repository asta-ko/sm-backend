...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('urls', type=str,
                            help='Принимает список урлов в формате '
                                 '"https://mos-gorsud.ru/rs/hamovnicheskij/services/cases/admin/details/a816fe67-4956'
                                 '-4b9c-9399-ea3908161023, '
                                 'https://mos-gorsud.ru/rs/zamoskvoreckij/services/cases/criminal/details/9ec54f94'
                                 '-417e-4107-b8d0-20f21852cb45" (в кавычках). Обязательный параметр.')
