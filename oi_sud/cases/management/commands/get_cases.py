...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--entry_date_from',
            type=str,
            help='Дата поступления дела, с которой начинаем забирать дела, в формате DD.MM.YYYY. Необязательный '
                 'параметр'
            )
        ...
        parser.add_argument(
            '--articles',
            type=str,
            help='Статьи, по которым забираем дела в формате "19.3 ч.1, 20.2 ч.5, 20.2 ч.8" (в кавычках). '
