...
district_dict = {
    ...
    'Северо-Западный': (10, 11, 29, 35, 39, 47, 51, 53, 60,  83),
...
def generate_tasks(v, year=None):
    ...
    collect_task = DjangoOperator(task_id=f'{court.id}-{v[0]}-{v[1]}-get-by-year',
...
#globals()['СПб'] = create_district_dag('ВСЁ_СПб', '@once', [78,])
