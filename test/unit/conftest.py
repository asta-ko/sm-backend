...
def moscow_courts():
   court_dicts = [
       {'url': 'https://mos-gorsud.ru/rs/shcherbinskij', 'title': 'Щербинский районный суд', 'phone_numbers': ['-'], 'region': 77,
        'site_type': 3, 'type': 2},
   ]
...
def better_courts():
   court_dicts = [
       {'url': 'https://musliumovsky--tat.sudrf.ru', 'title': 'Муслимовский районный суд', 'phone_numbers': ['-'], 'region': 78,
        'site_type': 1, 'type': 2},
