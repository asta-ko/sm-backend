...
def moscow_courts():
    court_dicts = [
        ...
        # {'url': 'https://mos-gorsud.ru/rs/taganskij', 'title': 'Таганский районный суд',
        #  'phone_numbers': ['-'],
        #  'region': 77,
        #  'site_type': 3, 'type': 2},
